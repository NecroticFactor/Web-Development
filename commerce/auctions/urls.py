...
urlpatterns = [
    ...
    path("watchlist/delete/<int:id>", views.delete_watchlist, name="delete_watchlist"),
    ...
    path("listings/detail/<int:id>/bid", views.new_bid, name="new_bid"),
    path("listing/user/<str:user>", views.user_listing, name="user_listing"),
